const fs = require('fs');
let content = fs.readFileSync('pages/Compliance/GSTReturn/filinglogic/CompositionFilingLogic.tsx', 'utf8');
...
content = newHook.trim();
fs.writeFileSync('pages/Compliance/GSTReturn/filinglogic/CompositionFilingLogic.tsx', content);
