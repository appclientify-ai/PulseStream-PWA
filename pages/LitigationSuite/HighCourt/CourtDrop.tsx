          ...
          <table className="w-full text-left border-collapse table-auto min-w-[1250px]">
            <thead className="whitespace-nowrap sticky top-0 z-20">
              <tr className="bg-slate-50 border-b border-slate-100">
                ...
                <th className="whitespace-nowrap px-6 py-5 text-[11px] font-black uppercase tracking-widest text-slate-400 w-[180px]">Outcome Ref</th>
                ...
                <th className="whitespace-nowrap px-6 py-5 text-[11px] font-black uppercase tracking-widest text-center w-[140px]">Outcome</th>
            ...
            <tbody className="divide-y divide-slate-100">
              {filteredRecords.length === 0 ? (
                <tr><td colSpan={8} className="whitespace-nowrap py-32 text-center text-slate-300 font-black uppercase tracking-widest text-sm">No High Court reliefs archived</td></tr>
              ) : (
                filteredRecords.map((rec, idx) => {
                  ...
                  return (
                    <tr key={rec.id} className="hover:bg-indigo-50/20 transition-all group text-[12px]">
                      ...
                      <td className="whitespace-nowrap px-6 py-5 font-black text-emerald-600 uppercase">{formatDisplayDate(rec.tioDate || rec.orderDate || rec.issuedDate)}</td>
