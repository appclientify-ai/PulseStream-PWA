    ...
    <nav className="fixed top-0 z-50 w-full bg-slate-950/50 px-6 py-4 backdrop-blur-lg border-b border-slate-800">
      <div className="mx-auto flex max-w-7xl items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          <button onClick={onLoginClick} className="rounded-full bg-indigo-600 px-8 py-2.5 text-sm font-bold text-white transition-all hover:bg-indigo-500 shadow-lg shadow-indigo-500/20 active:scale-95">
            Consultant Login
          </button>
        </div>
      </div>
